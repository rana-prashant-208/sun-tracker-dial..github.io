...
var textureObj = new THREE.TextureLoader().load( "texture/brick.jpg" );
...
var nightlight= new THREE.DirectionalLight(0xFFFFFF,1);
// light.position.set(-radius, radius, 0);
...
var material = new THREE.MeshLambertMaterial({ map: textureObj,color: new THREE.Color("white"), side: THREE.DoubleSide });
...
loader.load( 'fonts/CQMono_Regular.json', function ( font ) {
	loadedFont=font;
} );
